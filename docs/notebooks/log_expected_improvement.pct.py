...
def benchmark_SoS(search_space, observer, acq_qule_builder, initial_data, n_step, ax):
  
    gpflow_model = trieste.models.gpflow.build_gpr(initial_data, search_space, likelihood_variance=1e-7)
    model = trieste.models.gpflow.GaussianProcessRegression(gpflow_model, num_kernel_samples=100)
...
n_step = 50
ndim = 10
search_space = trieste.space.Box([0.0]  * ndim, [1.]  * ndim)
